...
public class Moving extends SomSkill {
    public Moving(PlayerData owner, SkillData skillData) {
    ...
    public boolean active() {
        ...
        SomParticle particle = new SomParticle(Color.WHITE, owner);
        SomEffect effect = new SomEffect(this, time);
        effect.setStatusMultiply(StatusType.Movement, percent);
