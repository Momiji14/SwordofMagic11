...
public class CriticalDamage extends SomSkill {
    public CriticalDamage(PlayerData owner, SkillData skillData) {
    ...
    public boolean active() {
        ...
        SomParticle particle = new SomParticle(Color.ORANGE, owner).setSpeed(0.35f);
        particle.sphere(owner.getHipsLocation(), 1);
        SomSound.LowHeal.radius(owner);
        SomEffect effect = new SomEffect(this, time);
        effect.setStatusMultiply(StatusType.CriticalDamage, percent);
