...
public class Minamoar extends SomSkill {

    public Minamoar(PlayerData owner, SkillData skillData) {
    ...
    public boolean active() {
        ...
        SomEffect effect = Mamoar.createEffect(owner, time).setPriority(value);
