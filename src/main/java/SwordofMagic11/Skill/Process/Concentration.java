...
public class Concentration extends SomSkill {
    public Concentration(PlayerData owner, SkillData skillData) {
    ...
    public boolean active() {
        ...
        SomParticle particle = new SomParticle(Color.YELLOW, owner).setSpeed(0.35f);
